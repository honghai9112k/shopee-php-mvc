            ...
            <div class="grid">
                <nav class="header__navbar">
                    <ul class="header__navbar-list">
                        <li class="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
                            <a href="http://localhost/shopee-php-mvc-dao/Home" style="text-decoration: none; color:#fff;">Vào cửa hàng trên ứng dụng Shopee</a>
                    ...
                    <ul class="header__navbar-list">
                        ...
                        <li class="header__navbar-item">
                            <a href="./Admin/AddProductView" class="header__navbar-item-link">
                ...
                <div class="header-with-search">
                    <div class="header__logo" onclick="renderAppContainer()">
                        <a href="http://localhost/shopee-php-mvc-dao/Admin">
