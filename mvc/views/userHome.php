            ...
            <div class="grid">
                <nav class="header__navbar">
                    <ul class="header__navbar-list">
                        <li class="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
                            <a href="http://localhost/bookstore-mvc/Admin" style="text-decoration: none; color:#fff;">Vào cửa hàng trên ứng dụng Shopee</a>
                                ...
                                <ul class="header__notify-list">
                                    <li class="header__notity-item header__notity-item-seen">
                                        <a href="" class="header__notify-link Non-underlined link">
                                            <img src="http://localhost/bookstore-mvc/public/asset/img/OMEN Cinematic Worlds - Lagoon.png" alt="" class="header__notify-img">
                ...
                <div class="header-with-search">
                    <div class="header__logo">
                        <a href="http://localhost/bookstore-mvc/Home">
