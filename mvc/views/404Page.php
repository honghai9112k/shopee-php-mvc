...
<body>
    <div class="app">
        ...
        <div class="app__container" style="min-height: 900px;" >
            <div style="text-align: center;">
                <img src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg//assets/8607b236f63f4c6f4fe479a079823622.svg" alt="">
                <h2 style="font-size: 20px;">Dịch vụ hiện đang bận</h2>
                <p style="font-size: 16px;">Vui lòng thử lại sau vì chúng tôi đang cố gắng khôi phục.</br> Chúng tôi xin lỗi vì sự bất tiện này.</p>
            </div>
            <div style="text-align: center;">
