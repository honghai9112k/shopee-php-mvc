...
<body>
    <div class="app">
        ...
        <div class="app__container">
            ...
            <?php require_once "./mvc/views/pages/listCart.php" ?>
            <?php require_once "./mvc/views/pages/product.php" ?>
        </div>
    ...
    <div class="modal">
        ...
        <div class="modal__body">
            ...
            <div class="new-product">
                ...
                <button onclick="creareProduct()" class="create-btn">Tạo sản phẩm</button>
            </div>
        </div>
    </div>
