...
<head>
    ...
    <link rel="icon" href="http://localhost/shopee-php-mvc-dao/public/asset/img/shopee.png" type="image/gif" sizes="16x16">
...
<body>
    <div class="app">
            ...
            <div class="grid">
                <nav class="header__navbar">
                    <ul class="header__navbar-list">
                        <li class="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
                            <a href="http://localhost/shopee-php-mvc-dao/Admin" style="text-decoration: none; color:#fff;">Vào cửa hàng trên ứng dụng Shopee</a>
                            <div class="header__qr">
                                <img src="http://localhost/shopee-php-mvc-dao/public/asset/img/qr_code.png" alt="QR code" class="header__qr-img">
                                <div class="header__qr-apps">
                                    <a href="" class="header__qr-link">
                                        <img src="http://localhost/shopee-php-mvc-dao/public/asset/img/google_play.jpg" alt="Google Play" class="header__qr-download-img">
                                    </a>
                                    <a href="" class="header__qr-link">
                                        <img src="http://localhost/shopee-php-mvc-dao/public/asset/img/app_store.png" alt="Google Play" class="header__qr-download-img">
                                    </a>
                            ...
                            <div class="header__notify">
                                ...
                                <ul class="header__notify-list">
                                    <li class="header__notity-item header__notity-item-seen">
                                        <a href="" class="header__notify-link Non-underlined link">
                                            <img src="http://localhost/shopee-php-mvc-dao/public/asset/img/OMEN Cinematic Worlds - Lagoon.png" alt="" class="header__notify-img">
                                            <div class="header__notify-info">
                                                <span class="header__notify-name">Sách chính hãng</span>
                                                <span class="header__notify-description">Mô tả sách</span>
                                            </div>
                                        </a>
                                    </li>
                ...
                <div class="header-with-search">
                    <div class="header__logo">
                        <a href="http://localhost/shopee-php-mvc-dao/Home">
        ...
        <footer class="footer">
                        ...
                        <div class="footer__download">
                            ...
                            <div class="footer__download-apps">
                                <a href="" class="footer__download-app-link">
                                    <img src="http://localhost/shopee-php-mvc-dao/public/asset/img/google_play.jpg" alt="" class="footer__download-app-img">
                                </a>
                                <a href="" class="footer__download-app-link">
                                    <img src="http://localhost/shopee-php-mvc-dao/public/asset/img/app_store.png" alt="" class="footer__download-app-img">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="footer__bottom">
                <div class="grid">
                    <p class="footer-text">2021 - Bản quyền thuộc về Nguyễn Hồng Hải</p>
                </div>
            </div>
        </footer>
    </div>
    ...
    <script src="./public/js/add_pj.js"></script> -->
